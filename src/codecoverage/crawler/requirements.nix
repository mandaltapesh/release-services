...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-4bnffgn8/src/codecoverage/crawler/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
